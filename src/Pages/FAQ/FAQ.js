...
const FAQ = () => {
    return (
        <div className='common-styles' data-aos="fade-up" data-aos-duration="1000">
            <PageTitle title="FAQ" />
            <h1 className='text-center second-font fw-bold mb-3'>Frequently Asked Questions</h1>

            <div className='faq-container'>
                <div className='h-100' data-aos="fade-right" data-aos-offset="100" data-aos-duration="1500" data-aos-easing="ease-in-sine">
                ...
                <div className='h-100' data-aos="fade-left" data-aos-offset="100" data-aos-duration="1500" data-aos-easing="ease-in-sine">
                    <div className='p-3 border border-2 rounded common-hover-effect h-100'>
