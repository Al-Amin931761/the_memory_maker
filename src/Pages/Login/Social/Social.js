...
const Social = () => {
    ...
    return (
        <div>
            ...
            <Button className='my-3' onClick={() => signInWithGithub()} variant="outline-dark"><BsGithub className='fs-2' /> Continue with Github</Button> <br />
            <Button onClick={() => signInWithFacebook()} variant="outline-dark"><BsFacebook className='fs-2' /> Continue with Facebook</Button>
            {errorElement}
        </div>
    );
};
