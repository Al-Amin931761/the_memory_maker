    ...
    <div className="common-styles" data-aos="fade-up" data-aos-duration="1000">
        ...
        >
          <div>
            <form onSubmit={handleRegister}>
              ...
              <button
                className={`mt-3 ${
                  registerButton ? "btn btn-dark" : "btn btn-outline-dark"
                }`}
      ...
      >
        <Modal.Header closeButton data-aos="fade-down" data-aos-duration="1000">
          <Modal.Title className="second-font">
            Terms and Conditions
          </Modal.Title>
        </Modal.Header>
        <Modal.Body>
          <div>
            <ol data-aos="fade-down" data-aos-duration="1000">
              ...
              <li>
                ...
                occurs less than six (6) calendar days before the portrait date,
                the Client forfeits the booking fee.
              </li>
              ...
              <li>
                ...
                exhibitions, advertising, and self-promotion. Usage outside the
                bounds of this agreement will require the Client's consent.
              </li>

              <li>
                <span className="fw-bold">Client's Usage: </span>The Client is
                obtaining prints for personal use only, and shall not sell said
                prints or authorize any reproductions thereof by parties other
                than the Photographer. If Client is obtaining a print for
                reproduction, Photographer authorizes Client to reproduce the
                print only as set forth under Special Usage Requirements. In
                such event, Client shall request that a copyright and credit
                notice for the Photographer be placed adjacent to the photograph
                on publication but shall have no liability if the publication
                refuses or omits to do so.
              </li>

              <li>
                <span className="fw-bold">Social Media: </span>This clause
                applies to all social media, including Facebook and blogs. When
                published online it is required that a citation of the
                photographer be made. The client agrees that they will under no
                circumstances alter any photographs that are placed in public on
                the internet. The client agrees to be responsible for any family
                member or friend who posts our photographs online and agrees
                that they cannot be cropped (with the exception of the forced
                cropping for Facebook's Timeline), altered in color, or edited
                in any way.
              </li>
              ...
              <li>
                ...
                other casualty, strike, or other cause beyond the control of the
                parties, or due to the Photographer's illness, then the
                Photographer shall return any funds previously paid to the
                Client but shall have no further liability with respect to the
                Agreement. This limitation on liability shall also apply in the
                event that photographic materials are damaged in processing,
                lost through camera malfunction, lost in the mail, or otherwise
                lost or damaged without fault on the part of the Photographer.
                In the event the Photographer fails to perform for any other
                reason, the Photographer shall not be liable for any amount in
                excess of the retail value of the Client's order.
              </li>

              <li>
                <span className="fw-bold">High-Resolution: </span>Images
                deliverable in High-Resolution (or known as High-Res) are 300DPI
                with 3000 Pixels in the longest edge.
              </li>

              <li>
                The Story Keeper keeps client files for up to 2 years after the
                photography session and is not liable for any claims after this
                period. All client files will be deleted and backups will be
              ...
              <li>
                The client accepts that all photographs will be taken and edited
                at the photographer's discretion based on the photographer's
                experience and artistic view. If the client has special requests
                shall create a “shot list” of all shots that they require.
              </li>
              ...
              <li>
                ...
                obstructed photos or photos ruined due to separate flashes going
                off or due to any other behavior from guests. The Story Keeper
                is not responsible for obstructed or ruined photos due to
                activities by other vendors and venue staff.
              </li>
            </ol>
          </div>
        </Modal.Body>
